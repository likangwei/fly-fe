(function (global, factory) {
	...
	var factoryWithTypeCheckers = function(isValidElement, throwOnDirectAccess) {
	  ...
	  function createEnumTypeChecker(expectedValues) {
	    if (!Array.isArray(expectedValues)) {
	      undefined !== 'production' ? warning_1$1(false, 'Invalid argument supplied to oneOf, expected an instance of array.') : void 0;
	  ...
	  function createUnionTypeChecker(arrayOfTypeCheckers) {
	    if (!Array.isArray(arrayOfTypeCheckers)) {
	      undefined !== 'production' ? warning_1$1(false, 'Invalid argument supplied to oneOfType, expected an instance of array.') : void 0;
	      return emptyFunction_1.thatReturnsNull;
	    }
	...
	*/
	...
	if (undefined !== 'production' && typeof isCrushed.name === 'string' && isCrushed.name !== 'isCrushed') {
	  warning$5('You are currently using minified code outside of NODE_ENV === \'production\'. ' + 'This means that you are running a slower development build of Redux. ' + 'You can use loose-envify (https://github.com/zertosh/loose-envify) for browserify ' + 'or DefinePlugin for webpack (http://stackoverflow.com/questions/30030031) ' + 'to ensure you have the correct code for your production build.');
	}
	...
	function _interopRequireWildcard(obj) {
	  if (obj && obj.__esModule) {
	    ...
	    if (obj != null) {
	      for (var key in obj) {
	        if (Object.prototype.hasOwnProperty.call(obj, key)) {
	          var desc = defineProperty$5 && getOwnPropertyDescriptor$3 ? getOwnPropertyDescriptor$3(obj, key) : {};
	...
	var defineProperty$6 = _objectDp$1.f;
	var _wksDefine$1 = function (name) {
	  var $Symbol = _core$1.Symbol || (_core$1.Symbol = _library$1 ? {} : _global$1.Symbol || {});
	  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty$6($Symbol, name, { value: _wksExt$1.f(name) });
	};
	...
	var getOwnPropertySymbols$3 = _core$1.Object.getOwnPropertySymbols;
	...
	function _objectSpread$1(target) {
	  for (var i = 1; i < arguments.length; i++) {
	    ...
	    if (typeof getOwnPropertySymbols$4 === 'function') {
	      ownKeys = ownKeys.concat(getOwnPropertySymbols$4(source).filter(function (sym) {
	        return getOwnPropertyDescriptor$3(source, sym).enumerable;
	      }));
	    }
	  ...
	  for (var i = 0; i < reducerKeys.length; i++) {
	    ...
	    if (undefined !== 'production') {
	      if (typeof reducers[key] === 'undefined') {
	        warning$6('No reducer provided for key "' + key + '"');
	      }
	    }
	...
	*/
	...
	if (undefined !== 'production' && typeof isCrushed$1.name === 'string' && isCrushed$1.name !== 'isCrushed') {
	  warning$6('You are currently using minified code outside of NODE_ENV === \'production\'. ' + 'This means that you are running a slower development build of Redux. ' + 'You can use loose-envify (https://github.com/zertosh/loose-envify) for browserify ' + 'or DefinePlugin for webpack (http://stackoverflow.com/questions/30030031) ' + 'to ensure you have the correct code for your production build.');
	}
	...
	**/
	...
	function takeEvery(patternOrChannel, worker) {
	  ...
	  return fork.apply(undefined, [sagaHelpers.takeEveryHelper, patternOrChannel, worker].concat(args));
	}
	...
	function takeLatest(patternOrChannel, worker) {
	  ...
	  return fork.apply(undefined, [sagaHelpers.takeLatestHelper, patternOrChannel, worker].concat(args));
	}
	...
	function throttle(ms, pattern, worker) {
	  ...
	  return fork.apply(undefined, [sagaHelpers.throttleHelper, ms, pattern, worker].concat(args));
	}
	...
	var io_21 = io.takeEvery;
	var io_22 = io.takeLatest;
	var io_23 = io.throttle;
	...
	**/
	...
	var utils_1$1 = utils$2.noop;
	var utils_2$1 = utils$2.returnSelf;
	var utils_3$1 = utils$2.isFunction;
	var utils_4$1 = utils$2.isArray;
	...
	var _invariant = interopRequireDefault$2(invariant_1$2);
	...
	var _warning = interopRequireDefault$2(warning_1$3);
	...
	function _iterableToArray$1(iter) {
	  if (isIterable$3(Object(iter)) || Object.prototype.toString.call(iter) === "[object Arguments]") return from$3(iter);
	}
	    ...
	    if (typeof type === 'string') {
	      ...
	      return sagaEffects.take(type.map(function (t) {
	        if (typeof t === 'string') {
	          ...
	          return (0, _prefixType.default)(type, model);
	        }
