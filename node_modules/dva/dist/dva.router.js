(function (global, factory) {
	...
	(global.dva = global.dva || {}, global.dva.router = factory(global.React));
	...
	*/
	...
	var createBrowserHistory = function createBrowserHistory() {
	  ...
	  var getDOMLocation = function getDOMLocation(historyState) {
	    ...
	    warning_1$2(!basename || hasBasename(path, basename), 'You are attempting to use a basename on a page whose URL path does not begin ' + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".');
	  ...
	  var push = function push(path, state) {
	    warning_1$2(!((typeof path === 'undefined' ? 'undefined' : _typeof$1(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
	    ...
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      ...
	      if (canUseHistory) {
	        ...
	        warning_1$2(state === undefined, 'Browser history cannot push state in browsers that do not support HTML5 history');
	  ...
	  var replace = function replace(path, state) {
	    warning_1$2(!((typeof path === 'undefined' ? 'undefined' : _typeof$1(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
	    ...
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      ...
	      if (canUseHistory) {
	        ...
	        warning_1$2(state === undefined, 'Browser history cannot replace state in browsers that do not support HTML5 history');
	...
	var createHashHistory = function createHashHistory() {
	  ...
	  var push = function push(path, state) {
	    warning_1$2(state === undefined, 'Hash history cannot push state; it is ignored');
	    ...
	    transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
	      ...
	      if (hashChanged) {
	        ...
	        warning_1$2(false, 'Hash history cannot PUSH the same path; a new entry will not be added to the history stack');
	  ...
	  var replace = function replace(path, state) {
	    warning_1$2(state === undefined, 'Hash history cannot replace state; it is ignored');
	  ...
	  var go = function go(n) {
	    warning_1$2(canGoWithoutReload, 'Hash history go(n) causes a full page reload in this browser');
	...
	var Router = function (_React$Component) {
	  ...
	  Router.prototype.componentWillMount = function componentWillMount() {
	    ...
	    invariant_1$1(children == null || React__default.Children.count(children) === 1, "A <Router> may have only one child element");
	  ...
	  var C = function C(props) {
	    ...
	    return React__default.createElement(Route, {
	      children: function children(routeComponentProps) {
	        return React__default.createElement(Component, _extends$10({}, remainingProps, routeComponentProps, {
	...
	var initialState = {
	  ...
	  if (type === LOCATION_CHANGE) {
	    return _extends$11({}, state, { location: payload });
	  }
	...
	var ConnectedRouter = function (_Component) {
	  _inherits$10(ConnectedRouter, _Component);

	  function ConnectedRouter() {
	    var _temp, _this, _ret;

	    _classCallCheck$10(this, ConnectedRouter);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn$10(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.handleLocationChange = function (location) {
